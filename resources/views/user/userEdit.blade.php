...
@section('main')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('indexUser') }}" class="btn btn-sm btn-dark"><span class="icon text-white-50"></span>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input autocomplete="off" type="email" name="email" readonly required value="{{ $user->email }}"
                            class="form-control" />
                        @error('email')
                            <p class="text-danger fs-6 fw-light my-2">{{ $message }}</p>
                        @enderror
